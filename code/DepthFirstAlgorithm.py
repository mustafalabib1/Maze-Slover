...
class DepthFirstAlgorithm(SearchAlgorithms):
    """
    Implementation of Depth First Algorithm's algorithm for grid-based pathfinding.
    Colors:
    ...
    def search(self): 
        """
        Execute Depth First algorithm to find the shortest path from origin to goal.
        """
        ...
        while len(self.to_visit) != 0:  # While there are cells to visit
            current_cell = self.to_visit.pop()  
